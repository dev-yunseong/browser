...
| #261 | [JS] dynamic import() support (Part of #247) (in progress by opencode:deepseek-v4-pro) | Depends on #260. Needs import.meta pattern for module namespace access. |
| #262 ✓ | [JS] Respect nomodule attribute (Part of #247) | Depends on #246. Script extraction must filter by attribute. |
| #263 | [JS] Module script load/error lifecycle events (Part of #247) (in progress by opencode:deepseek-v4-pro) | Depends on #246. Events fire after module evaluation completes/fails. |
