...
| #264 | [JS] async/defer attribute and module execution ordering (Part of #247) (in progress by opencode:deepseek-v4-pro) | Depends on #260-#263. Execution ordering builds on full semantics. |
